        ...
        <div className={`dashboard-container ${darkMode ? "dark-mode" : ""}`}>
            ...
            <div className="main-content p-4">
                ...
                <main>
                    ...
                    <div className="mb-4 d-flex gap-2 flex-wrap">
                        {categoryOptions.map((category) => (
                            <button
                                ...
                                className={`btn ${String(filterCategory) === String(category.id)
                                    ? "btn-success"
                    ...
                    {isLoading ? <div className="text-muted mb-3">Dang tai menu...</div> : null}
                            ...
                            <div className="card shadow-sm">
                                            ...
                                            {foods.map((food) => (
                                                ...
                                                >
                                                    <td>
                                                        <div className="d-flex align-items-center gap-3">
                                                            <img
                                                                src={food.image_url || "https://via.placeholder.com/50x50?text=Food"}
                                                                alt={food.name}
                                                                width="50"
                                                                height="50"
                                                                className="rounded"
                                ...
                                <div className="card-footer d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    <small className="text-muted">
                                        Trang {currentPage}/{pagination.totalPages} - Tổng {pagination.totalItems} món
                                    </small>

                                    <div className="btn-group" role="group" aria-label="Phân trang món ăn">
                                        <button
                                            type="button"
                            ...
                            {selectedFood ? (
                                <div className="card shadow-sm">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="text-muted mb-2">{selectedFood.category_name}</p>
                                        <div className="mb-3">{getStatusBadge(selectedFood.is_active)}</div>
                                        <p className="text-muted">{selectedFood.description || "Khong co mo ta"}</p>
                                        ...
                                        {selectedFoodDetail?.variants?.length ? (
                                            <ul className="mb-0 ps-3">
                                                {selectedFoodDetail.variants.map((variant) => (
                                                    <li key={variant.id}>
                                                        {variant.size_display || variant.size}: {Number(variant.price || 0).toLocaleString("vi-VN")}đ
                                                    </li>
                                                ))}
                                            </ul>
                                        ) : (
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="submit" className="btn btn-success" disabled={isSubmitting}>
                                        {isSubmitting ? "Dang luu..." : editingFood ? "Cập nhật" : "Thêm"}
                                    </button>
                                </div>
                            </form>
                        </div>
